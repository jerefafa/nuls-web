...
if(isset($_GET['subject_id'])){
    ...
    $stmt = $conn->query("SELECT * FROM `subjects` WHERE `subject_id`= '".$subject_id."' ");
...
<div id="container">
    ...
    <div id="content">
        <div class="row">
            <form class="col s12" method="post" action="subject_update.php">
                <input required type="hidden" name="subject_id" value="<?php echo $subject_id ?>">
                <div class="input-field col s4">
                    <input id="subject_name" type="text" name="subject" class="validate" value="<?php echo $subject ?>" pattern="[A-Za-z\s]{5,}">
