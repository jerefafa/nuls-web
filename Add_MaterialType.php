...
<div id="container">
    ...
    <div id="content">
        <div class="row">
            <form class="col s12" method="post" action="material_add.php">
                <div class="input-field col s4">
                    <input required id="material_type" type="text" class="validate" name="amaterial" pattern="[A-Za-z\s]{2,}">
                    <label for="material_type">Material Type</label>
                </div>

                <div class="col s4" >
                    <button class="waves-effect waves-light btn" value="save" style="margin-top: 5%; margin-left: 5%" name="addMaterial">Save</button>
                </div>
            </form>
        </div>
    </div>
