...
if(isset($_GET['subtype_id'])){
    ...
    $stmt = $conn->query("SELECT * FROM `subtypes` WHERE `subtype_id`= '".$subtype_id."' ");
...
<div id="container">
    ...
    <div id="content">
        <div class="row">
            <form class="col s12" method="post" action="subtype_update.php">
                <div class="input-field col s4">
                    <input required type="hidden" name="subtype_id" value="<?php echo $subtype_id ?>">
                    <input id="subtype" type="text" class="validate" value="<?php echo $subtype?>" name="asubtype" pattern="[A-Za-z\s]{2,}">
