...
<div id="container">
    ...
    <div id="content">
        ...
        <form action='supplier_delete.php' method='post' id='$row->supplier_id'><button onclick='showPrompt(`".$row->supplier_name."`,`".$row->supplier_id."`)' class='btn-floating material-icons' type='button' value='delete' style='border: 0px;color: white;font-size: x-large;'>delete</button><input type='hidden' name='supplier_id' value='".$row->supplier_id."'></form></td></tr>";
            }
            ?>
            </tbody>
        </table>
